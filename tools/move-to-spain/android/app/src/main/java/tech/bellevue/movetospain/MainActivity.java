package tech.bellevue.movetospain;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LOCAL_URL = "https://bellevue.tech/tools/move-to-spain/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assetLoader = new WebViewAssetLoader.Builder()
                ...
                .addPathHandler("/tools/move-to-spain/",
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view,
                ...
                if ("bellevue.tech".equals(host)) {
                    if (path != null && (path.equals("/tools/move-to-spain/")
                            || path.equals("/tools/move-to-spain"))) {
                        Uri indexUrl = url.buildUpon()
                                .path("/tools/move-to-spain/index.html").build();
        ...
        public void shareFile(String content, String filename, String mimeType) {
            try {
                ...
                Uri uri = FileProvider.getUriForFile(
                        MainActivity.this, "tech.bellevue.movetospain.fileprovider", file);
