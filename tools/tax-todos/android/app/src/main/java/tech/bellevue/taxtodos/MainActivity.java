package tech.bellevue.taxtodos;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LOCAL_URL = "https://bellevue.tech/tools/tax-todos/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assetLoader = new WebViewAssetLoader.Builder()
                ...
                .addPathHandler("/tools/tax-todos/",
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view,
                ...
                if ("bellevue.tech".equals(host)) {
                    if (path != null && (path.equals("/tools/tax-todos/")
                            || path.equals("/tools/tax-todos"))) {
                        Uri indexUrl = url.buildUpon()
                                .path("/tools/tax-todos/index.html").build();
        ...
        public void shareFile(String content, String filename, String mimeType) {
            try {
                ...
                Uri uri = FileProvider.getUriForFile(
                        MainActivity.this, "tech.bellevue.taxtodos.fileprovider", file);
