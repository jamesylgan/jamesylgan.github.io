package tech.bellevue.furnitureplanner;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LOCAL_URL = "https://bellevue.tech/tools/furniture-planner/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assetLoader = new WebViewAssetLoader.Builder()
                ...
                .addPathHandler("/tools/furniture-planner/",
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view,
                ...
                if ("bellevue.tech".equals(host)) {
                    if (path != null && (path.equals("/tools/furniture-planner/")
                            || path.equals("/tools/furniture-planner"))) {
                        Uri indexUrl = url.buildUpon()
                                .path("/tools/furniture-planner/index.html").build();
        ...
        public void shareFile(String content, String filename, String mimeType) {
            try {
                ...
                Uri uri = FileProvider.getUriForFile(
                        MainActivity.this, "tech.bellevue.furnitureplanner.fileprovider", file);
