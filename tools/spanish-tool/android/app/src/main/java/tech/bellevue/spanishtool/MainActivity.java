package tech.bellevue.spanishtool;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LOCAL_URL = "https://bellevue.tech/tools/spanish-tool/";
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public WebResourceResponse shouldInterceptRequest(WebView view,
                ...
                if ("bellevue.tech".equals(host)) {
                    if (path != null && (path.equals("/tools/spanish-tool/")
                            || path.equals("/tools/spanish-tool"))) {
                        Uri indexUrl = url.buildUpon()
                                .path("/tools/spanish-tool/index.html").build();
        ...
        public void shareFile(String content, String filename, String mimeType) {
            try {
                ...
                Uri uri = FileProvider.getUriForFile(
                        MainActivity.this, "tech.bellevue.spanishtool.fileprovider", file);
