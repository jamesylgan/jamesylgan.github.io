...
const translationsVI = {
  ...
  ui: {
    ...
    learnExamples: 'Ví dụ',
    learnTip: 'Mẹo',
    learnBadgeGrammar: 'Ngữ pháp',
    learnBadgeConj: 'Chia ĐT',
    learnSubtitleGrammar: 'Mẫu ngữ pháp',
    learnSubtitleConj: 'Chia động từ',
  ...
  // Learn lesson translations (conjugation quick reference pages)
  learnLessons: {
    present_ser_estar: {
      title: 'Ser vs Estar (Hiện tại)',
      intro: 'Cả hai đều có nghĩa là "là/ở," nhưng <strong>ser</strong> dùng cho đặc điểm cố định (bản chất, nguồn gốc, nghề nghiệp) và <strong>estar</strong> dùng cho trạng thái tạm thời (vị trí, tâm trạng, tình trạng).',
      rule: 'Ser = bạn LÀ ai/cái gì. Estar = bạn ĐANG ở đâu/như thế nào.',
      examples: [
        'Tôi là sinh viên. (bản chất cố định)',
        'Tôi đang mệt. (trạng thái tạm thời)',
        'Cô ấy đến từ Mexico. (nguồn gốc)',
        'Cô ấy đang ở văn phòng. (vị trí)',
      ],
      tip: 'Nhớ: "Ser" cho DOCTOR (Mô tả, Nghề nghiệp, Đặc điểm, Thời gian, Nguồn gốc, Mối quan hệ). "Estar" cho PLACE (Tư thế, Vị trí, Hành động, Tình trạng, Cảm xúc).',
    },
    present_ar: {
      title: 'Động từ -AR (Hiện tại)',
      intro: 'Nhóm động từ phổ biến nhất trong tiếng Tây Ban Nha. Bỏ đuôi <strong>-ar</strong> và thêm đuôi thì hiện tại.',
      rule: 'hablar → habl- + đuôi',
      examples: [
        'Tôi nói tiếng Tây Ban Nha.',
        'Cô ấy làm việc ở ngân hàng.',
        'Chúng tôi học cùng nhau.',
      ],
      tip: 'Động từ -AR là nhóm lớn nhất. Nắm vững các đuôi này và bạn có thể chia hàng trăm động từ!',
    },
    present_er_ir: {
      title: 'Động từ -ER/-IR (Hiện tại)',
      intro: 'Nhóm động từ thứ hai và thứ ba có đuôi rất giống nhau. Bỏ <strong>-er</strong> hoặc <strong>-ir</strong> và thêm đuôi.',
      rule: 'comer → com- + đuôi / vivir → viv- + đuôi',
      examples: [
        'Tôi ăn lúc hai giờ.',
        'Họ sống ở Madrid.',
        'Bạn viết rất hay.',
      ],
      tip: 'Sự khác biệt duy nhất giữa -ER và -IR: nosotros (-emos vs -imos) và vosotros (-éis vs -ís). Mọi thứ khác đều giống nhau.',
    },
    present_irregular: {
      title: 'Động từ bất quy tắc (Hiện tại)',
      intro: 'Các động từ thường dùng này có biến đổi không theo quy tắc. Hầu hết chỉ bất quy tắc ở dạng <strong>yo</strong> hoặc có biến đổi gốc từ (e→ie, o→ue, e→i).',
      rule: 'Biến đổi gốc: querer → quiero, poder → puedo, decir → digo. Bất quy tắc yo: tener → tengo, hacer → hago, saber → sé.',
      examples: [
        'Tôi có hai anh chị em.',
        'Chúng tôi đi xem phim.',
        'Cô ấy có thể nói ba thứ tiếng.',
      ],
      tip: 'Biến đổi gốc theo "hình chiếc ủng" — ảnh hưởng tất cả các dạng NGOẠI TRỪ nosotros và vosotros (giữ nguyên gốc từ).',
    },
    preterite_ar: {
      title: 'Động từ -AR (Quá khứ đơn)',
      intro: 'Quá khứ đơn mô tả <strong>hành động đã hoàn thành trong quá khứ</strong>. Với động từ -AR, bỏ -ar và thêm đuôi quá khứ đơn.',
      rule: 'hablar → habl- + đuôi quá khứ đơn',
      examples: [
        'Tôi đã nói chuyện với cô ấy hôm qua.',
        'Cô ấy đã mua một chiếc váy mới.',
        'Họ đã làm việc cả ngày.',
      ],
      tip: 'Lưu ý: dạng nosotros (-amos) giống hệt thì hiện tại! Ngữ cảnh cho biết đó là thì nào.',
    },
    preterite_er_ir: {
      title: 'Động từ -ER/-IR (Quá khứ đơn)',
      intro: 'Ở thì quá khứ đơn, động từ -ER và -IR có đuôi <strong>hoàn toàn giống nhau</strong>.',
      rule: 'comer → com- + đuôi / vivir → viv- + đuôi',
      examples: [
        'Tôi đã ăn paella ở Valencia.',
        'Anh ấy đã sống ở Barcelona hai năm.',
        'Cô ấy đã viết một lá thư.',
      ],
      tip: 'Khác với thì hiện tại nơi -ER và -IR hơi khác nhau, ở quá khứ đơn chúng giống 100%!',
    },
    preterite_irregular: {
      title: 'Động từ bất quy tắc (Quá khứ đơn)',
      intro: 'Một số động từ thường dùng có gốc quá khứ đơn hoàn toàn bất quy tắc. Chúng dùng chung một bộ đuôi <strong>không nhấn</strong> đặc biệt.',
      ...
      tip: 'Ser và ir có cùng dạng quá khứ đơn (fui, fuiste, fue...). Ngữ cảnh cho biết là động từ nào.',
    },
    imperfect: {
      title: 'Thì quá khứ tiếp diễn',
      intro: 'Thì quá khứ tiếp diễn mô tả <strong>hành động đang diễn ra, thói quen, hoặc bối cảnh</strong> trong quá khứ. Chỉ có 3 động từ bất quy tắc (ser, ir, ver).',
      rule: '-AR: -aba, -abas, -aba, -ábamos, -abais, -aban. -ER/-IR: -ía, -ías, -ía, -íamos, -íais, -ían.',
      examples: [
        'Khi tôi còn nhỏ, tôi hay chơi trong công viên.',
        'Cô ấy luôn ăn lúc ba giờ.',
        'Có rất nhiều người ở bữa tiệc.',
      ],
      tip: 'Quá khứ đơn = "chuyện gì đã xảy ra" (hoàn thành). Quá khứ tiếp diễn = "chuyện gì đang xảy ra / thường xảy ra" (bối cảnh/thói quen).',
    },
    future: {
      title: 'Tương lai đơn',
      intro: 'Thì dễ nhất để tạo! Thêm đuôi vào <strong>nguyên dạng đầy đủ</strong> (không bỏ -ar/-er/-ir).',
      rule: 'hablar + đuôi = hablaré, hablarás, hablará...',
      examples: [
        'Ngày mai tôi sẽ nói chuyện với sếp.',
        'Chúng tôi sẽ ăn lúc tám giờ.',
        'Cô ấy sẽ có em bé vào tháng Năm.',
      ],
      tip: 'Tương lai bất quy tắc thay đổi GỐC TỪ nhưng giữ nguyên đuôi: tener→tendr-, poder→podr-, hacer→har-, decir→dir-, salir→saldr-.',
    },
    conditional: {
      title: 'Thì điều kiện',
      intro: 'Diễn tả hành động "sẽ làm." Giống thì tương lai, thêm đuôi vào <strong>nguyên dạng đầy đủ</strong>. Cùng gốc bất quy tắc với tương lai.',
      rule: 'hablar + đuôi = hablaría, hablarías, hablaría...',
      examples: [
        'Tôi sẽ nói chuyện với cô ấy, nhưng tôi không có thời gian.',
        'Tôi muốn một ly cà phê, làm ơn.',
        'Chúng ta có thể đi xem phim tối nay.',
      ],
      tip: 'Đuôi thì điều kiện giống hệt đuôi quá khứ tiếp diễn -ER/-IR (-ía, -ías...), nhưng gắn vào nguyên dạng đầy đủ.',
    },
    subjunctive_present: {
      title: 'Giả định (Hiện tại)',
      intro: 'Dùng sau các từ kích hoạt nghi ngờ, mong muốn, cảm xúc, hoặc sự cần thiết. Giả định "đảo" nguyên âm: động từ -AR dùng đuôi -e, động từ -ER/-IR dùng đuôi -a.',
      rule: 'Từ kích hoạt + que + giả định. -AR: -e, -es, -e, -emos, -éis, -en. -ER/-IR: -a, -as, -a, -amos, -áis, -an.',
      examples: [
        'Tôi muốn bạn nói chậm hơn.',
        'Điều quan trọng là bạn phải ăn uống tốt.',
        'Tôi nghi ngờ điều đó là sự thật.',
      ],
      tip: 'Các từ kích hoạt WEIRDO: Wishes (Mong muốn), Emotions (Cảm xúc), Impersonal expressions (Biểu thức vô nhân xưng), Recommendations (Khuyến nghị), Doubt/Denial (Nghi ngờ/Phủ nhận), Ojalá.',
    },
    present_perfect: {
      title: 'Hiện tại hoàn thành',
      intro: 'Mô tả hành động <strong>đã xảy ra</strong>. Cấu tạo bằng <strong>haber</strong> (hiện tại) + quá khứ phân từ (-ado/-ido).',
      rule: 'he/has/ha/hemos/habéis/han + hablado/comido/vivido',
      examples: [
        'Tôi đã nói chuyện với cô ấy hôm nay.',
        'Họ đã ăn rồi.',
        'Tôi chưa bao giờ sống ở nước ngoài.',
      ],
      tip: 'Quá khứ phân từ bất quy tắc: hecho (hacer), dicho (decir), escrito (escribir), visto (ver), puesto (poner), vuelto (volver), abierto (abrir).',
    },
    past_perfect: {
      title: 'Quá khứ hoàn thành',
      intro: 'Mô tả điều <strong>đã xảy ra</strong> trước một sự kiện quá khứ khác. Cấu tạo bằng <strong>haber</strong> (quá khứ tiếp diễn) + quá khứ phân từ.',
      rule: 'había/habías/había/habíamos/habíais/habían + hablado/comido',
      examples: [
        'Tôi đã ăn rồi khi bạn đến.',
        'Cô ấy chưa bao giờ sống một mình.',
        'Chúng tôi đã nói chuyện trước cuộc họp.',
      ],
      tip: 'Hãy nghĩ nó như "quá khứ của quá khứ" — điều đã hoàn thành trước một hành động quá khứ khác.',
    },
    future_perfect: {
      title: 'Tương lai hoàn thành',
      intro: 'Mô tả điều <strong>sẽ đã xảy ra</strong> vào một thời điểm tương lai. Cũng dùng để phỏng đoán về quá khứ. Cấu tạo bằng <strong>haber</strong> (tương lai) + quá khứ phân từ.',
      rule: 'habré/habrás/habrá/habremos/habréis/habrán + hablado/comido',
      examples: [
        'Đến năm giờ, tôi sẽ đã hoàn thành.',
        'Họ chắc đã đến rồi. (phỏng đoán)',
      ],
      tip: 'Thì này thường dùng để phỏng đoán: "Habrá salido ya" = "Chắc anh ấy đã đi rồi."',
    },
    conditional_perfect: {
      title: 'Điều kiện hoàn thành',
      intro: 'Mô tả điều <strong>đã có thể xảy ra</strong>. Cấu tạo bằng <strong>haber</strong> (điều kiện) + quá khứ phân từ.',
      rule: 'habría/habrías/habría/habríamos/habríais/habrían + hablado/comido',
      examples: [
        'Tôi đã đi, nhưng tôi bị ốm.',
        'Cô ấy đã nói, nhưng cô ấy sợ.',
      ],
      tip: 'Dùng trong câu "nếu" về quá khứ: "Si hubiera sabido, habría ido." (Nếu tôi đã biết, tôi đã đi.)',
    },
    subjunctive_imperfect: {
      title: 'Giả định (Quá khứ)',
      intro: 'Dùng khi từ kích hoạt giả định ở thì quá khứ. Có hai dạng (-ra và -se), nhưng -ra phổ biến hơn.',
      rule: 'Lấy dạng ellos quá khứ đơn, bỏ -ron, thêm: -ra, -ras, -ra, -ramos, -rais, -ran.',
      examples: [
        'Tôi muốn bạn nói chuyện với cô ấy.',
        'Nếu tôi giàu, tôi sẽ đi du lịch nhiều.',
        'Tôi nghi ngờ điều đó là sự thật.',
      ],
      tip: 'Mẫu "si + giả định quá khứ + điều kiện" là chìa khóa cho câu "nếu" tiếng Tây Ban Nha: "Si tuviera tiempo, iría."',
    },
    subjunctive_present_perfect: {
      title: 'Giả định (Hiện tại hoàn thành)',
      intro: 'Dùng khi từ kích hoạt giả định liên quan đến điều <strong>đã xảy ra</strong>. Cấu tạo bằng <strong>haber</strong> (giả định hiện tại) + quá khứ phân từ.',
      rule: 'haya/hayas/haya/hayamos/hayáis/hayan + hablado/comido',
      examples: [
        'Tôi hy vọng bạn đã ăn.',
        'Tôi nghi ngờ họ đã đến.',
      ],
      tip: 'Chỉ cần ghép giả định hiện tại của "haber" (haya, hayas...) với quá khứ phân từ.',
    },
    subjunctive_pluperfect: {
      title: 'Giả định (Quá khứ hoàn thành)',
      intro: 'Dùng trong điều kiện không thực ở quá khứ ("nếu tôi đã..."). Cấu tạo bằng <strong>haber</strong> (giả định quá khứ) + quá khứ phân từ.',
      rule: 'hubiera/hubieras/hubiera/hubiéramos/hubierais/hubieran + hablado/comido',
      examples: [
        'Nếu tôi đã học, tôi đã đỗ.',
        'Ước gì bạn đã đến bữa tiệc.',
      ],
      tip: 'Đây là thì "tiếc nuối" — những điều đã không xảy ra nhưng bạn ước đã xảy ra.',
    },
    imperative_affirmative: {
      title: 'Mệnh lệnh (Khẳng định)',
      intro: 'Dùng cho <strong>mệnh lệnh và yêu cầu</strong>. Dạng tú: dùng dạng hiện tại él/ella. Usted: dùng giả định hiện tại.',
      rule: 'Tú: habla, come, vive. Usted: hable, coma, viva. Nosotros: hablemos, comamos.',
      examples: [
        'Nói chậm hơn, làm ơn.',
        'Ăn rau đi.',
        'Chúng ta đi biển đi.',
      ],
      tip: '8 dạng tú mệnh lệnh bất quy tắc thường gặp: di (decir), haz (hacer), ve (ir), pon (poner), sal (salir), sé (ser), ten (tener), ven (venir).',
    },
    imperative_negative: {
      title: 'Mệnh lệnh (Phủ định)',
      intro: 'Để nói "đừng làm gì," dùng <strong>no</strong> + dạng giả định hiện tại cho tất cả ngôi.',
      rule: 'No + giả định: No hables, No comas, No vivas. (Cùng dạng giả định cho tất cả ngôi.)',
      examples: [
        'Đừng nói nhanh quá.',
        'Đừng ăn cái đó.',
        'Đừng lo, thưa ông.',
      ],
      tip: 'Khác với mệnh lệnh khẳng định, mệnh lệnh phủ định LUÔN LUÔN dùng giả định — kể cả cho tú. Không có bất quy tắc nào cần nhớ!',
    },
    pronoun_placement: {
      title: 'Vị trí đại từ: "Quiero que tú..." vs "Te lo quiero..."',
      intro: 'Một trong những mẫu khó nhất trong tiếng Tây Ban Nha: khi nào đại từ đứng <strong>trước</strong> động từ và khi nào đứng <strong>sau</strong> (gắn liền). Chìa khóa là có <strong>hai mệnh đề</strong> hay <strong>một mệnh đề với nguyên dạng/danh động từ</strong>.',
      pattern1Title: 'Mẫu 1: Hai mệnh đề với "que" (chủ ngữ khác nhau)',
      pattern1Desc: 'Khi bạn muốn NGƯỜI KHÁC làm gì, bạn cần hai mệnh đề nối bằng "que." Động từ thứ hai phải ở dạng <strong>giả định</strong>.',
      p1ex1: 'Tôi muốn bạn nói tiếng Tây Ban Nha.',
      p1ex2: 'Tôi cần cô ấy giúp tôi.',
      p1ex3: 'Tôi thích họ làm điều đó hơn.',
      p1ex4: 'Tôi hy vọng bạn đến bữa tiệc.',
      pattern1Structure: 'Cấu trúc: [Chủ ngữ 1] + [động từ 1] + <strong>que</strong> + [Chủ ngữ 2] + [động từ giả định 2]',
      pattern2Title: 'Mẫu 2: Cùng chủ ngữ + nguyên dạng (đại từ có thể di chuyển)',
      pattern2Desc: 'Khi BẠN thực hiện cả hai hành động, không có "que." Đại từ tân ngữ có thể đứng <strong>trước</strong> động từ chia hoặc <strong>gắn sau</strong> nguyên dạng.',
      p2ex1: 'Tôi muốn đưa nó cho bạn.',
      p2ex2: 'Tôi có thể giải thích cho anh ấy/cô ấy.',
      p2ex3: 'Tôi đang ăn hết nó.',
      p2ex4: 'Tôi sẽ mua nó.',
      pattern2Note: 'Cả hai vị trí đều đúng như nhau. Đặt đại từ TRƯỚC động từ chia phổ biến hơn trong giao tiếp hàng ngày.',
      pattern3Title: 'Mẫu 3: Với danh động từ (-ando/-iendo)',
      pattern3Desc: 'Đại từ gắn vào cuối danh động từ HOẶC đứng trước động từ trợ (estar/seguir/v.v.).',
      p3ex1: 'Tôi đang làm nó.',
      p3ex2: 'Anh ấy/Cô ấy tiếp tục giải thích cho tôi.',
      pattern3Note: 'Khi gắn, thêm dấu nhấn để giữ nguyên trọng âm: haciéndo + lo = haciéndolo.',
      pattern4Title: 'Mẫu 4: Với mệnh lệnh khẳng định',
      pattern4Desc: 'Đại từ PHẢI gắn vào cuối mệnh lệnh khẳng định. Đại từ đứng TRƯỚC mệnh lệnh phủ định.',
      p4ex1: 'Khẳng định: đại từ gắn sau.',
      p4ex2: 'Phủ định: đại từ đứng trước.',
      p4ex3: 'Mua nó đi. → Đừng mua nó.',
      pronounOrderTitle: 'Thứ tự đại từ: khi xếp hai đại từ',
      pronounOrderDesc: 'Khi kết hợp đại từ tân ngữ gián tiếp (IO) + trực tiếp (DO), IO luôn đứng trước. "Le/les" biến thành "se" trước "lo/la/los/las."',
      combined: 'Kết hợp',
      example: 'Ví dụ',
      poEx1: 'Anh ấy đưa nó cho tôi.',
      poEx2: 'Tôi gửi nó cho bạn.',
      poEx3: 'Tôi đã nói điều đó với anh ấy/cô ấy.',
      poEx4: 'Anh ấy mang chúng cho chúng tôi.',
      comparisonTitle: 'So sánh nhanh: que + giả định vs nguyên dạng',
      thPattern: 'Mẫu',
      thWhy: 'Tại sao?',
      cmpWhy1: 'Hai chủ ngữ khác nhau',
      cmpWhy2: 'Cùng chủ ngữ làm cả hai',
      cmpWhy3: 'Tôi hy vọng CÔ ẤY đến',
      cmpWhy4: 'Tôi hy vọng tự mình làm được',
      cmpWhy5: 'Đại từ trước động từ trợ',
      cmpWhy6: 'Gắn vào mệnh lệnh khẳng định',
      cmpWhy7: 'Trước mệnh lệnh phủ định',
      cmdPos: 'mệnh lệnh (+)',
      cmdNeg: 'mệnh lệnh (-)',
      keyTestLabel: 'Mẹo kiểm tra:',
      keyTestText: 'Hỏi "ai làm hành động thứ hai?" Nếu là NGƯỜI KHÁC → dùng "que" + giả định. Nếu CÙNG NGƯỜI → dùng nguyên dạng, và đại từ có thể di chuyển. Với mệnh lệnh: gắn sau khẳng định, trước phủ định.',
    },
  },
};
